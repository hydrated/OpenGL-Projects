...
public class TextureManager 
{
	...
	public String addTextureId(int glId , String $id , boolean $generateMipMap) {
	...
	public String addTextureId(int glId, String $id)
	{
		return this.addTextureId(glId, $id, false);
	}
