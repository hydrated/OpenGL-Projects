...
public class ArcRectangle extends Object3dContainer
{
	public ArcRectangle(float $width, float $height, int $segsW, int $segsH)
	{
		this($width, $height, $segsW, $segsH, new Color4(255, 0, 0, 255));
	}
	
	public ArcRectangle(float $width, float $height, int $segsW, int $segsH, Color4 color)
	{
