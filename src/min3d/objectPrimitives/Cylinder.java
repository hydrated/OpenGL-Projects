 ...
 */
public class Cylinder extends Object3dContainer
{
	...
	public Cylinder(float $radius, float $height ,int $columns, int $rows, Boolean $useUvs, Boolean $useNormals, Boolean $useVertexColors)
	{
		super(
			($columns+1) * ($rows+1),
			$columns * $rows * 2,
	...
	public Cylinder(float $radius, float $height, int $columns, int $rows)
	{
		super(
				($columns+1) * ($rows+1),
				$columns * $rows * 2,
	...
	public Cylinder(float $radius, float $height, int $columns, int $rows, Color4 color)
	{
		super(
				($columns+1) * ($rows+1),
				$columns * $rows * 2,
