...
public class SplashActivity extends ListActivity  
{
	...
	private ItemVo[] _items = {
			...
			new ItemVo("hydra test", ExampleHydra.class, "ExampleHydra.java") ,
			new ItemVo("activitytoStart", ActivitytoStart.class, "ActivitytoStart.java") ,
			new ItemVo("launcher ex test", ExampleLauncher2.class, "ExampleLauncher2.java") ,
			new ItemVo("water wave demo", ExampleWaterSimulate.class, "ExampleWaterSimulate.java") ,
			new ItemVo("launcher test2", ExampleLauncher3.class, "ExampleLauncher3.java") ,
			new ItemVo("ultra laun" , ExampleFrameBuffer.class , "ExampleFrameBuffer.java") ,
			new ItemVo("DLauncherAPP" , DLauncherAPP.class , "DLauncherAPP.java")			
	};
