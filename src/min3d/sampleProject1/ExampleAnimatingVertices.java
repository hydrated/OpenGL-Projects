...
public class ExampleAnimatingVertices extends RendererActivity
{
	...
	public void initScene() 
	{
		...
		light.ambient.setAll(0x22222222);
		light.specular.setAll(0xffffffff) ;
		light.diffuse.setAll(0xffffffff) ;
		light.position.setAll(0, 0, -5);
		light.spotCutoffAngle(10f) ;
		light.direction.setAll(0f, 0f, 1f) ;
		light._spotExponent.set(2f) ;
		//light.attenuationSetAll(1.0f, 0.0f, 0.0f) ;
